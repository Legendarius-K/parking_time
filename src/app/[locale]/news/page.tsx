...
const client = createClient({space: 'e8ftnq4591uc', accessToken: 'jJNKUQVZXmnGnf1IQqmZk4vH86IBgl5kGpC-KPk2aIw'})
...
}catch(error){console.log("aaaaaaaaaaaaaaaaaaa"+error)}}
getAllEntries();
        ...
        //       const FetchNews = News.map((news: any) =>({
        //         Title: news.fields.Title,
        //          paragraph: news.fields.paragraph,
        //          date: news.fields.date,
        //          image: news.fields.image?.fields.file.fileName,
        //       }));
        //       setCards(FetchNews);
        //     } catch (error) {
