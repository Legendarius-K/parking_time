...
const Download = () => {
    const t = useTranslations('download')
        return (
            <>
                <div className="flex flex-col md:flex-row justify-center items-center mt-[3%] content-normal">
                    <div className="order-1 md:order-2 mb-8 md:mb-[8%] flex justify-center items-center md:w-auto">
                    ...
                    <div className="order-2 md:order-1 flex flex-col max-w-lg w-full md:w-auto">
                        ...
                        <p className="font-nunito font-thin w-full md:w-1000%] leading-loose mt-5 p-[5%]">
                            {t("paragraf")}
                        </p>
